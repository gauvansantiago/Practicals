# Gauvan Santiago Prac_02 Task_01 string_formatting_examples
name = "Gibson L-5 CES"
year = 1922
cost = 16035.4
...
# This produces the output "1922 Gibson L-5 CES for about $16,035!"
print("{} {} for about ${:,.0f}!".format(year, name, cost))

# produces the (right-aligned numbers)
